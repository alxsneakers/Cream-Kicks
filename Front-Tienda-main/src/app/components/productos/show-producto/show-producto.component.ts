...
export class ShowProductoComponent implements OnInit {
  ...
  */
  ...
  constructor(private _route: ActivatedRoute, private _guestService: GuestService, private _notificationService: NotificationService, private _clienteService: ClienteService) {
    ...
    this._guestService.obtener_producto_publico(this.idProducto).subscribe(
      response =>{
        this.producto= response;
        console.log(this.producto)
        // carga los productos recomendados segun la marca del producto que el usuario esta viendo
        this._guestService.listar_productos_recomendados_publico(this.producto.marca).subscribe(
          response =>{
  ...
  agregar_producto(){
    ...
    if(this.carrito_data.talla){
      ...
      this._clienteService.agregar_carrito_cliente(data, this.token).subscribe(
        ...
        error =>{ // producto duplicado en el carrito
      ...
      this._notificationService.openSnackBar('Debes de seleccionar una talla.', 'cerrar');
    }
  ...
  onChangeTalla(value: any) {
    this._clienteService.obtener_stock_talla(this.idProducto, value.target.value).subscribe(
      response =>{
        this.stock= response;        
      }
    )
